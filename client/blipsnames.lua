...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('B4-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('B4-admin:client:toggleBlips', function()
...
RegisterNetEvent('B4-admin:client:toggleNames', function()
...
RegisterNetEvent('B4-admin:client:Show', function(players)
